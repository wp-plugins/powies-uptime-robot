...
<h2><?php _e('Uptime Robot Settings', 'pum') ?></h2>
<form method="post" action="options.php">
<?php
settings_fields( 'pum-settings' );
if  ( get_option('postfield-legend') == '' ) {
	update_option('postfield-legend',__('Post Content','pum'));
}
?>
<div id="poststuff">
<div class="postbox">
<h3><?php _e('API Settings', 'pum') ?></h3>
	<div class="inside">
    <table class="form-table">
        <tr valign="top">
        	<th scope="row"><?php _e('API Key', 'pum') ?></th>
...
<div id="poststuff">
<div class="postbox">
<h3><?php _e('Shortcode Usage', 'pum') ?></h3>
	<div class="inside">
		<?php _e('Use the shortcode <code>[pum]</code> to show the status list on a page or post.', 'pum') ?>
    </div>
</div>

<div class="postbox">
<h3><?php _e('About', 'pum') ?></h3>
